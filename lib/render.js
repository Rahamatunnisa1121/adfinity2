...
function renderHeader(options = {}) {
  ...
  const desktopSearch = `<div class="adf-nav-search nav-search"><form action=/search id=search-form1 class=navbar-form role=search><div class="form-group mb0"><div class=input-group><div id=search-prod class="input-group-append clicked"><img src=/resources/images/search-icon.png alt=""></div><input autocomplete=off type=text class="nav-search-input form-control" placeholder="Search product" name=q id=search_term1></div></div></form></div>`;
  ...
  return `<header><div id=header><div id=hd-top><nav class="navbar navbar-expand-lg navbar-light adf-navbar">${brandLogo}<div class=adf-nav-wrap>${desktopSearch}<ul class="navbar-nav adf-nav-primary ml-auto"><li class="nav-item"><a class="nav-link nav-about${aboutActive}" href=/about><span>About</span></a></li><li class="nav-item"><a class="nav-link nav-contact${contactActive}" href=/contact><span>Contact</span></a></li><li class="nav-item dropdown adf-nav-search-item"><a class="nav-link adf-nav-btn adf-nav-btn-search dropdown-toggle" href=# id=adfSearchToggle data-toggle=dropdown aria-haspopup=true aria-expanded=false><span>Search</span></a><div class="dropdown-menu adf-nav-dropdown adf-search-dropdown" aria-labelledby=adfSearchToggle><div class=nav-search-form><form action=/search id=search-form2 class=navbar-form role=search><div class="form-group mb0"><div class=input-group><input autocomplete=off type=text class="nav-search-input form-control" placeholder="Search product" name=q id=search_term2><div id=search-prod2 class="input-group-append clicked"><img src=/resources/images/search-icon.png alt=""></div></div></div></form></div></div></li>${chooseCategoryMobile}</ul></div></nav></div><div id=hd-bot><nav class="navbar navbar-expand-lg navbar-light adf-navbar-bot"><ul class="navbar-nav adf-cat-choose">${chooseCategoryDesktop}${searchTagLinks}</ul><ul class="navbar-nav nav-right ml-auto">${bottomRight}</ul></nav></div></div></header>`;
}
